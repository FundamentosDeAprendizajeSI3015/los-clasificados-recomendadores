...
def parse_args() -> argparse.Namespace:
	parser = argparse.ArgumentParser(description="Entrena Regresion Logistica para genero_libro_rec")
...
def resolve_dataset_path(data_path: Path | None) -> Path:
	...
	raise FileNotFoundError(
		"No se encontro un CSV con la columna target 'genero_libro_rec'. "
